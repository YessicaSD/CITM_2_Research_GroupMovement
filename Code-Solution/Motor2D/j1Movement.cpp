...
//
//						Unit_Direction dirA = singleUnit->unit->GetUnitDirection();
//						Unit_Direction dirB = (*units)->unit->GetUnitDirection();
//
//						singleUnit->waitUnit = *units;
//						singleUnit->waitTile = singleUnit->nextTile;
//
...
//{
//	Unit_Direction dirA = singleUnitA->unit->GetUnitDirection();
//	Unit_Direction dirB = singleUnitB->unit->GetUnitDirection();
//
//	switch (dirA) {
//
//	case UnitDirection_Up:
